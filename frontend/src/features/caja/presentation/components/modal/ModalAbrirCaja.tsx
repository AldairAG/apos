...
// TODO: reemplaza esta constante por la fuente real del saldo inicial fijo
// (config de la sucursal, variable de entorno, valor guardado en backend, etc.)
const SALDO_INICIAL_FIJO = 2000;
                ...
                <View className="bg-white rounded-t-3xl">
                    ...
                    <View className="px-4 pt-6 pb-8">
                        ...
                        <View className="border border-[#E7E0EC] rounded-xl px-4 py-3 mb-1 bg-[#F1EEF4]">
                            <Text className="text-base text-[#1C1B1F]">{formatMoney(SALDO_INICIAL_FIJO)}</Text>
                        </View>
